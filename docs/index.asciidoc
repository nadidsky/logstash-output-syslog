...
| <<plugins-{type}s-{plugin}-use_octet_counting>> |<<boolean,boolean>>|No
|=======================================================================
...
use octet counting allows rfc5424 to follow rfc6587 and
send events without limited length, useful for long event messages with line feeds 
and null characters. The receiving end would wait until receiving all the message size
